...
import com.itlesports.backportedwolves.entity.mob.wolf.StripedWolfEntity;
import net.minecraft.src.Entity;
import net.minecraft.src.ModelBase;
import net.minecraft.src.RenderWolf;
import net.minecraft.src.ResourceLocation;

public class RenderStripedWolf extends RenderWolf {
    private static final ResourceLocation WOLF_DO_NOT_WORRY_TEXTURES = new ResourceLocation("entity/mob/wolf/stripedwolf_angry.png");
    ...
    protected static final ResourceLocation wolfTextures = new ResourceLocation("entity/mob/wolf/stripedwolf.png");
    protected static final ResourceLocation tamedWolfTextures = new ResourceLocation("entity/mob/wolf/stripedwolf_tame.png");
    protected static final ResourceLocation angryWolfTextures = new ResourceLocation("entity/mob/wolf/stripedwolf_angry.png");
    protected static final ResourceLocation wolfCollarTextures = new ResourceLocation("entity/mob/wolf/wolf_collar.png");

    public RenderStripedWolf(ModelBase par1ModelBase, ModelBase par2ModelBase, float par3) {
    ...
    {
        return this.func_110914_a((StripedWolfEntity) par1Entity);
    }
}
