...
import com.itlesports.backportedwolves.entity.mob.wolf.SpottedWolfEntity;
...
public class SpottedWolfRenderer extends RenderSpottedWolf{

    private static final ResourceLocation WOLF_DO_NOT_WORRY_TEXTURES = new ResourceLocation("entity/mob/wolf/spottedwolf_angry");
    ...
    public SpottedWolfRenderer(ModelBase model, ModelBase modelOverlay, float fShadowSize )
    {
    ...
    {
        if ( renderGlowingEyes((SpottedWolfEntity)entity, iRenderPass) )
        {
            return 1;
        }
    ...
    private boolean renderGlowingEyes(SpottedWolfEntity wolf, int iRenderPass)
    {
