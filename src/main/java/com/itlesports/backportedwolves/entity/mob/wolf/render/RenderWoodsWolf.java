...
import com.itlesports.backportedwolves.entity.mob.wolf.WoodsWolfEntity;
import net.minecraft.src.Entity;
import net.minecraft.src.ModelBase;
import net.minecraft.src.RenderWolf;
import net.minecraft.src.ResourceLocation;

public class RenderWoodsWolf extends RenderWolf {
    private static final ResourceLocation WOLF_DO_NOT_WORRY_TEXTURES = new ResourceLocation("entity/mob/wolf/woodswolf_angry.png");
    ...
    protected static final ResourceLocation wolfTextures = new ResourceLocation("entity/mob/wolf/woodswolf.png");
    protected static final ResourceLocation tamedWolfTextures = new ResourceLocation("entity/mob/wolf/woodswolf_tame.png");
    protected static final ResourceLocation angryWolfTextures = new ResourceLocation("entity/mob/wolf/woodswolf_angry.png");
    protected static final ResourceLocation wolfCollarTextures = new ResourceLocation("entity/mob/wolf/wolf_collar.png");

    public RenderWoodsWolf(ModelBase par1ModelBase, ModelBase par2ModelBase, float par3) {
    ...
    {
        return this.func_110914_a((WoodsWolfEntity) par1Entity);
    }
}
