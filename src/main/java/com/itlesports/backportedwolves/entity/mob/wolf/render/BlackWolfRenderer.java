...
import com.itlesports.backportedwolves.entity.mob.wolf.BlackWolfEntity;
...
public class BlackWolfRenderer extends RenderBlackWolf{

    private static final ResourceLocation WOLF_DO_NOT_WORRY_TEXTURES = new ResourceLocation("entity/mob/wolf/blackwolf_angry");
    ...
    public BlackWolfRenderer(ModelBase model, ModelBase modelOverlay, float fShadowSize )
    {
    ...
    {
        if ( renderGlowingEyes((BlackWolfEntity)entity, iRenderPass) )
        {
            return 1;
        }
    ...
    private boolean renderGlowingEyes(BlackWolfEntity wolf, int iRenderPass)
    {
